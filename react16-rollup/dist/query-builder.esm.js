    ...
    switch (type) {
      ...
      case "BOOLEAN":
        return index.createElement(
          ...
          index.createElement("option", { value: "" }),
          index.createElement(
            "option",
            { value: props.copy.filter.boolean.true.id },
            props.copy.filter.boolean.true.label
          ),
          index.createElement(
            "option",
            { value: props.copy.filter.boolean.false.id },
  ...
  createClass(Filter, [{
    ...
    value: function render() {
      ...
      var combinatorOptions = this.props.combinators.map(function (combinator) {
        return index.createElement(
          "option",
          { key: combinator, value: combinator },
          combinator
        );
      });
        ...
        index.createElement(
          ...
          index.createElement(
            ...
            validInputs && index.createElement(
              "a",
              { className: "filter-plus", href: "", onClick: this.handleAddQuery },
              "+"
            ),
            this.state.selectedAttribute && index.createElement(
              "a",
              { className: "filter-minus", href: "", onClick: this.handleReset },
              "-"
            )
          )
        )
...
index$3.render(index.createElement(QueryBuilder, null), document.getElementById("app"));
