...
var _jsxFileName$4 = "C:\\Users\\anton_000\\Desktop\\query-builder\\react16-rollup\\src\\components\\queries\\index.js";
function Queries(props) {
  var _this = this;

  var queries = props.queries.map(function (query) {
    return index.createElement(
      "span",
      { className: "query", key: query.id, __source: {
      ...
      index.createElement(
        "span",
        { className: "query-operator", __source: {
            fileName: _jsxFileName$4,
            lineNumber: 7
          },
          __self: _this
      ...
      index.createElement(
        "a",
        {
          ...
          onClick: function onClick(e) {
            return props.onClick(e, query.id);
          },
          __source: {
            fileName: _jsxFileName$4,
            lineNumber: 11
...
var _jsxFileName$5 = "C:\\Users\\anton_000\\Desktop\\query-builder\\react16-rollup\\src\\components\\filter-input\\index.js";
function FilterInput(props) {
  function renderInput(type) {
    ...
    switch (type) {
      case "STRING":
        return index.createElement("input", {
      ...
      case "BOOLEAN":
        return index.createElement(
          ...
          index.createElement("option", { value: "", __source: {
              fileName: _jsxFileName$5,
              lineNumber: 39
            },
            __self: this
          ...
          index.createElement(
            "option",
            { value: props.copy.filter.boolean.true.id, __source: {
                fileName: _jsxFileName$5,
                lineNumber: 40
              },
              __self: this
          ...
          index.createElement(
            "option",
            { value: props.copy.filter.boolean.false.id, __source: {
                fileName: _jsxFileName$5,
                lineNumber: 43
              },
              __self: this
      ...
      case "ENUM":
        var enumOptions = props.enum.map(function (item) {
          return index.createElement(
            "option",
            { key: item, value: item, __source: {
                fileName: _jsxFileName$5,
                lineNumber: 50
              },
              __self: _this
  ...
  if (props.selectedAttribute) {
    var inputType = props.selectedAttribute.split("_")[1];
...
var _jsxFileName$3 = "C:\\Users\\anton_000\\Desktop\\query-builder\\react16-rollup\\src\\components\\filter\\index.js";
var Filter = function (_React$Component) {
  ...
  function Filter(props) {
    ...
    _this.state = {
      selectedOrganization: _this.props.entities[0].id,
      selectedAttribute: "",
      selectedOperator: "",
      selectedInput: "",
      selectedCombinator: _this.props.combinators[0],
      queries: [],
      attributes: _this.props.attributes.reduce(function (object, item) {
        var key = Object.keys(item)[0];
        object[key] = item[key];
        return object;
      }, {}),
      operators: Object.keys(_this.props.operators).map(function (operator) {
        return {
          id: operator,
          label: _this.props.operators[operator]
        };
      })
    };

    _this.handleInputChange = _this.handleInputChange.bind(_this);
    _this.handleAddQuery = _this.handleAddQuery.bind(_this);
    _this.handleRemoveQuery = _this.handleRemoveQuery.bind(_this);
  ...
  createClass(Filter, [{
    ...
    key: "handleAddQuery",
    value: function handleAddQuery(event) {
      var queries = [].concat(toConsumableArray(this.state.queries));
    ...
    value: function handleRemoveQuery(event, id) {
      event.preventDefault();

      var queries = this.state.queries.filter(function (query) {
        return query.id !== id;
      });
    ...
    value: function render() {
      ...
      var organizationOptions = this.props.entities.map(function (entity) {
        return index.createElement(
          "option",
          { key: entity.id, value: entity.id, __source: {
      ...
      var attributeOptions = this.state.attributes[this.state.selectedOrganization].map(function (attribute) {
        return index.createElement(
          "option",
          { key: attribute, value: attribute, __source: {
              fileName: _jsxFileName$3,
              lineNumber: 92
            },
            __self: _this2
      ...
      var operatorOptions = this.state.operators.map(function (operator) {
        return index.createElement(
          "option",
          { key: operator.id, value: operator.id, __source: {
              fileName: _jsxFileName$3,
              lineNumber: 98
            },
            __self: _this2
      ...
      var combinatorOptions = this.props.combinators.map(function (combinator) {
        return index.createElement(
          "option",
          { key: combinator, value: combinator, __source: {
              fileName: _jsxFileName$3,
              lineNumber: 104
            },
            __self: _this2
      ...
      var validInputs = this.state.selectedOrganization && this.state.selectedAttribute && this.state.selectedOperator && this.state.selectedInput;

      return index.createElement(
        "form",
        { className: "filter-form", __source: {
            fileName: _jsxFileName$3,
            lineNumber: 116
          },
          __self: this
        ...
        index.createElement(
          "div",
          { className: "primary-content", __source: {
              fileName: _jsxFileName$3,
              lineNumber: 117
            },
            __self: this
        ...
        index.createElement(
          "div",
          { className: "secondary-content", __source: {
              fileName: _jsxFileName$3,
              lineNumber: 133
            },
            __self: this
          },
          this.state.queries.length > 0 && index.createElement(
            "select",
            {
              className: "filter-dropdown",
          ...
          index.createElement(
            ...
            index.createElement(
              "option",
              { value: "", disabled: true, hidden: true, __source: {
                  fileName: _jsxFileName$3,
                  lineNumber: 150
                },
                __self: this
          ...
          this.state.selectedAttribute && index.createElement(
            "select",
            {
              className: "filter-dropdown",
          ...
          index.createElement(FilterInput, {
          ...
          index.createElement(
            "div",
            { className: "filter-icons", __source: {
                fileName: _jsxFileName$3,
                lineNumber: 175
              },
              __self: this
            },
            validInputs && index.createElement(
              "a",
              { className: "filter-plus", href: "", onClick: this.handleAddQuery, __source: {
                  fileName: _jsxFileName$3,
                  lineNumber: 177
                },
                __self: this
            ...
            this.state.selectedAttribute && index.createElement(
              "a",
              { className: "filter-minus", href: "", onClick: this.handleReset, __source: {
                  fileName: _jsxFileName$3,
                  lineNumber: 181
                },
                __self: this
...
var _jsxFileName$2 = "C:\\Users\\anton_000\\Desktop\\query-builder\\react16-rollup\\src\\components\\panel\\index.js";
...
__$styleInject("* {\n  box-sizing: border-box;\n}\n\nhtml {\n  font-size: calc(10px + (24 - 10) * (100vw - 320px) / (1920 - 320));\n}\n\nbody {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif;\n  margin: 0;\n  padding: 2rem 3rem;\n}\n\n.query-builder {\n  margin: 0 auto;\n  max-width: 1024px;\n}\n\n.panel {\n  border: 2px solid black;\n}\n\n.panel-heading {\n  background: black;\n  color: white;\n  font-size: 1rem;\n  font-weight: normal;\n  margin: 0;\n  padding: .3em .5em .4em;\n}\n\n.filter-form {\n  padding: .8rem;\n}\n\n.primary-content {\n  display: flex;\n}\n\n.secondary-content {\n  align-items: center;\n  display: flex;\n  margin-top: .8rem;\n}\n\n.filter-dropdown,\n.filter-input {\n  border: 1px solid rgb(169, 169, 169);\n  border-radius: .2rem;\n  display: flex;\n  margin-right: .8rem;\n  padding: .2rem;\n}\n\n.filter-icons {\n  display: flex;\n}\n\n.filter-plus,\n.filter-minus,\n.query-remove {\n  align-items: center;\n  color: white;\n  display: flex;\n  font-family: monospace;\n  font-size: 1.2rem;\n  height: 1.3rem;\n  justify-content: center;\n  text-decoration: none;\n  width: 1.3rem;\n}\n\n.filter-plus {\n  background: #4caf50;\n  margin-right: .8rem;\n}\n\n.filter-minus {\n  background: red;\n}\n\n.query-remove {\n  color: black;\n  display: inline;\n  margin-left: .8rem;\n  font-weight: bold;\n}\n\n.queries {\n  display: flex;\n}\n\n.queries span:last-child {\n  border-right: 0;\n}\n\n.query {\n  border-right: 1px solid rgb(169, 169, 169);\n  padding: 0 .8rem;\n}\n\n.query-operator {\n  color: #2196f3;\n}\n", undefined);

var _jsxFileName$1 = "C:\\Users\\anton_000\\Desktop\\query-builder\\react16-rollup\\src\\query-builder.js";
var QueryBuilder = function (_React$Component) {
  ...
  function QueryBuilder() {
    ...
    var _this = possibleConstructorReturn(this, (QueryBuilder.__proto__ || Object.getPrototypeOf(QueryBuilder)).call(this));
  ...
  createClass(QueryBuilder, [{
    ...
    value: function componentDidMount() {
      ...
      var response = fetch(CONSTANTS.ENDPOINT).then(function (response) {
    ...
    key: "render",
    value: function render() {
      var content = this.state.data ? index.createElement(Panel, {
      ...
      return index.createElement(
        "main",
        { className: "query-builder", __source: {
            fileName: _jsxFileName$1,
            lineNumber: 34
          },
          __self: this
...
var _jsxFileName = "C:\\Users\\anton_000\\Desktop\\query-builder\\react16-rollup\\src\\index.js";
index$3.render(index.createElement(QueryBuilder, {
  __source: {
